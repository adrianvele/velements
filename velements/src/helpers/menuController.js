...
export default class MenuController {
  constructor(el) {
    ...
    this.DOM.headline = {
      ...
      text: this.DOM.el.querySelector(
        ".menu__headline > .menu__headline-text > span"
      ),
    };
    ...
    gsap
      ...
      .to(
        [
          ...
          menuItem.contentPage.DOM.textInner,
        ...
        ],
        {
          ...
          onStart: () => {
            gsap.set(
              [
                menuItem.contentPage.DOM.title,
                menuItem.contentPage.DOM.intro,
                menuItem.contentPage.DOM.text,
                menuItem.contentPage.DOM.date,
              ],
              {
                opacity: 1,
                stagger: -0.06,
  ...
  showMenu(menuItem) {
    ...
    // Scroll up first
    scrollIt(menuOffset, 300, "easeOutQuad", () => {
      gsap
        .timeline({
          defaults: timelineDefaults,
          onStart: () => (this.isAnimating = true),
        ...
        .to(document.body, { backgroundColor: "#111" }, 0)
        .to(
          menuItem.contentPage.DOM.galleryItems,
          {
            y: "100%",
